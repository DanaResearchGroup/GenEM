...
class TestMolecule(unittest.TestCase):
    ...
    def test_calculate_properties(self):
        ...
        self.assertAlmostEqual(props_eth['molecular_weight'], 46.04186, places=4)
        self.assertAlmostEqual(props_eth['logp'], -0.0014, places=4)
        self.assertGreaterEqual(props_eth['sascore'], 1)
        self.assertLessEqual(props_eth['sascore'],10)
        self.assertAlmostEqual(props_eth['ob_percentage'], -208.5, delta=1.0)
        ...
        self.assertGreaterEqual(self.tnt.properties['sascore'], 1)
        self.assertLessEqual(self.tnt.properties['sascore'], 10)
        self.assertAlmostEqual(self.tnt.properties['ob_percentage'], -74.0, delta=1.0)
