...
class TestMolecule(unittest.TestCase):
    ...
    def test_smiles_to_mol(self):
        ...
        generated_eth_smiles = Chem.CanonSmiles(Chem.MolToSmiles(self.ethanol.rdkit_mol))
        expected_tnt_smiles = Chem.CanonSmiles(self.tnt_smiles)  # Canonicalize SMILES
        generated_tnt_smiles = Chem.CanonSmiles(Chem.MolToSmiles(self.tnt.rdkit_mol))
