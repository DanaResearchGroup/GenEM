...
class TestMolecularDifferentialEvolution(unittest.TestCase):
    def setUp(self):
        ...
        self.optimizer = MolecularDifferentialEvolution(self.objective_function, self.initial_smiles, max_iter=20)
    ...
    def test_crossover(self):
        ...
        self.assertIsInstance(trial, Molecule, "Crossover should return a Molecule object.")
    ...
    def test_selection(self):
        ...
        self.assertEqual(self.optimizer.molecular_space[idx].smiles, MOLECULES_SMILES.get("TNT"),
        ...
        self.assertEqual(self.optimizer.best_fitness, len(MOLECULES_SMILES.get("TNT")),
                         "The best fitness should be updated to the trial molecule's fitness.")
        self.assertEqual(self.optimizer.best_solution.smiles, MOLECULES_SMILES.get("TNT"),
    ...
    def test_run_optimization(self):
        ...
        self.assertGreaterEqual(best_fitness, max(len(smiles) for smiles in self.initial_smiles), "Best fitness should be greater or equal to intial best fitness after optimization.")
